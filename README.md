...
This project can be used to build a
[Debian 12 (Bookworm)](https://www.debian.org/releases/bookworm/) AMI.
...
AWS_PROFILE=cool-images-ec2amicreate-debian-packer packer build --timestamp-ui -var release_tag=$(./bump_version.sh show) -var is_prerelease=true src/packer.pkr.hcl
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-debian-packer packer build --timestamp-ui -var-file release.pkrvars.hcl src/packer.pkr.hcl
```
